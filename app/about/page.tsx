        ...
        <section className={styles.comment}>
          ...
          <div className={styles.text}>
            <p>
              ...
              <br />
              志望職種はフロントエンドエンジニア、Webエンジニア、システムエンジニアです。HTML、CSS、JavaScriptの基本的な知識の勉強をしており、WordPressやmicroCMSなどのCMSを使った作品も制作経験があります。現在はNext.jsの勉強を進めており、今後もいろいろな技術を勉強していきたいと思っています。
            </p>
          </div>
        </section>
